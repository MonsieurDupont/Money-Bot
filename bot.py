...
async def blackjack(interaction: discord.Interaction, amount: int):
    ...
    embed.add_field(name="Vous", value={[card_to_emoji(Card.int_to_str(card)) for card in player_cards]})
    embed.add_field(name="T", value=f"{blackjack_sessions[user_id].evaluate_hand(player_cards)}")

...
class Bot(commands.Bot):
    ...
    @commands.tree.command(name="register", description="S'inscrire")
    ...
    @commands.tree.command(name="balance", description="Vérifier votre solde")
    ...
    @commands.tree.command(name="deposit", description="Déposer de l'argent")
    ...
    @commands.tree.command(name="work", description="Travailler")
    ...
    @commands.tree.command(name="stats", description="Afficher les statistiques")
    ...
    @commands.tree.command(name="steal", description="Volé de l'argent à un utilisateur")
    ...
    @commands.tree.command(name="send", description="Envoyer de l'argent")
    ...
    @commands.tree.command(name="leaderboard", description="Voir le classement des joueurs")
    ...
    @commands.tree.command(name="transaction_history", description="Historique des transactions")
    ...
    @commands.tree.command(name="help", description="Afficher les commandes disponibles")
    ...
    @commands.tree.command(name="give", description="Se give de l'argent | ADMINS SEULEMENT")
    ...
    @commands.tree.command(name="delete_account", description="Supprimer le compte")

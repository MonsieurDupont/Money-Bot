...
@bot.slash_command()(name="register", description="S'inscrire")
...
@bot.slash_command()(name="balance", description="Vérifier votre solde")
...
@bot.slash_command()(name="deposit", description="Déposer de l'argent")
...
@bot.slash_command()(name="work", description="Travailler")
...
@bot.slash_command()(name="stats", description="Afficher les statistiques")
...
@bot.slash_command()(name="steal", description="Volé de l'argent à un utilisateur")
...
@bot.slash_command()(name="send", description="Envoyer de l'argent")
...
@bot.slash_command()(name="leaderboard", description="Voir le classement des joueurs")
...
@bot.slash_command()(name="transaction_history", description="Historique des transactions")
...
@bot.slash_command()(name="help", description="Afficher les commandes disponibles")
...
@bot.slash_command()(name="give", description="Se give de l'argent | ADMINS SEULEMENT")
...
@bot.slash_command()(name="delete_account", description="Supprimer le compte")
